...
prescriptive 規定式框架在 Level 2 還能運作——因為 Level 2 有人類兜底。系統處理不了的，人來接手。但 Level 3 沒有這個安全網。系統說「我在開」的那一刻起，它必須處理一切。用 If-Then 列舉來處理一切，就像用一本有限頁數的字典來涵蓋一門語言的所有可能句子。這是不可能的任務。
