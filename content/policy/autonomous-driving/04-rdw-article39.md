...
**第三道關卡：車輛數量限制。** 規定明確寫著，審查報告可以「載明限制條件（如車輛數）」。3/17 會議上台北市汽車代理商公會提出的 20 輛上限，不是空穴來風——它有法源依據。20 輛車在一個數萬名 Tesla 車主的市場裡，是象徵性開放，不是真正的部署。
...
**第二步：移除車輛數量限制。** Article 39 在歐洲沒有數量限制。如果台灣接受了 Article 39 的認證邏輯，就不該用一個 20 輛的天花板把它掐死。數量限制不是安全措施——是市場保護。
