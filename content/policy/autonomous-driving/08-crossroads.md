...
| **2032** | **R171 (DCAS) Phase 1+2 各型式全面適用** | **落後國際 7 年 3 個月** |
| **2036** | **R171 (DCAS) Phase 3 各型式全面適用** | **天花板仍然只是 EAP** |

結構性模式一目了然（詳見第五部分的完整分析）：R79 落後 7 年、R171 落後 7 年 3 個月、R157 落後 10 年——差距不是在縮小，是在擴大。每一條法規，在台灣全面實施的時候，在國際上已經進入下一代或已經死亡。

**而且 2032 不是終點，終點也不是 FSD。**

3/17 草案參考的是 R171 **01 series（Phase 1+2）**——解鎖的是 **EAP 等級**。**Phase 3（02 series）** 2026/6 才會在 WP.29 通過、2027/1 左右國際生效。VSCC 得等現在這一輪跑完才會處理，套用同樣的 7 年節奏——**Phase 3 在台灣各型式全面適用，要到 2035-2036 年。**

但最關鍵的是：**即使把 R171 三階段全部跑完，天花板仍然是 EAP，永遠到不了 FSD。** prescriptive 規定式 + 場景正面表列的設計，從根本上就管不到 FSD 的核心能力（城市街道、紅綠燈、無保護左轉、圓環匯入、自動尋位停車）。

想要 FSD 的兩條路都不在 R171 家族裡：

- **FSD 監督版** → **Article 39（RDW 路線）** — 2026/4/10 已核准 Tesla
- **FSD 無監督版（真正自動駕駛）** → **L3+ ADS GTR** — 2024/6 草案成立，各國啟動國內程序受理

**這就是為什麼 R171 永遠不是答案，也不應該是台灣的主戰場。** 走 Path A 的本質，不是「等 2032 就有 FSD」——而是**「用 10 年換到 EAP，仍然沒有 FSD」**。
...
Path B 的路徑一立即可用——不再是理論，而是有一份具體的歐洲認證書可以採認。接不接，已經不是技術問題，是純粹的政策決定。
...
荷蘭的 RDW 做的事完全不同。RDW 不只審查——它**主動願意受理** Article 39 申請，沒有說「我們還沒準備好」。它主動投入 18 個月建立審查新技術的能力。它在歐盟車輛技術委員會（TCMV）裡主動推動相互承認。它的自我定位不是守門員——是荷蘭乃至歐洲自駕技術的**推進者**。
