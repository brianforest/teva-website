...
**先說清楚這條提案的字面內容**：R79 轉向系統早就有一個「少量車型」條款——年銷量低於 20 輛的小眾車型（例如進口特殊車型），可以走**簡化檢測程序**，減少不成比例的檢測負擔。公會建議把這個門檻比照搬到 DCAS（R171）的條文 1.3。

單看這條提案本身——小眾車型走簡化程序——字面上並沒有毛病。對小量進口代理商反而有利。

但真正值得留意的，是**這個提案出現的方式**。

一場純技術的檢測基準條文檢討會議，出席名單裡當然會有車輛工業公會（車廠代表）——因為草案內容直接影響他們的產品檢測流程。但**代理商**公會——賣進口車的——主動就「少量車型數量規定」提出具體數字建議，這個身份與介入方式值得留意。

- 小眾進口代理商（年銷量本來就少的品牌）**有直接利益**將門檻設在 20 輛：自家代理的品牌能享受簡化程序
- 對主流量大品牌的競爭者（例如 Tesla）來說，20 輛的門檻沒有直接好處也沒有直接壞處——量大品牌本來就要走完整程序

在法規討論的會議桌上，利益團體的聲音不會直接說「我們反對新技術」。它會穿上技術的外衣——安全疑慮、數量管控、本地化測試——每一個聽起來都合情合理。即使這一次的提案字面上站得住腳，但**賣車的公會主動替一條新技術條文提供具體數字**，這個行為模式本身，就是值得公眾監督的訊號。

這不是陰謀論。這是所有產業面對創新時的標準動作。但你應該知道，在那場你不知道的會議裡，有人正在替新技術的檢測規則建議具體數字——而提議者不是檢測機構、不是安全專家，是賣車的代理商。
...
| **2032** | **台灣 DCAS (R171 Phase 1+2) 各型式全面適用** | **落後國際 7 年 3 個月** |
| **2036（推算）** | **台灣 DCAS (R171 Phase 3) 各型式全面適用** | **天花板仍然只是 EAP** |
