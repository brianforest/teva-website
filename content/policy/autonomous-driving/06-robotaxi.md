...
> - **五大立法缺口**——駕駛人定義、事故責任歸屬、保險體系、無方向盤型式認證、緊急情境處理——MR14-04 管的是「有駕駛人」的系統，Robotaxi 的問題完全超出其範圍，台灣目前完全空白
...
更諷刺的是——回想第一篇提到的 R79。它在 2003 年已經鬆綁，允許 Steer-by-Wire 線控轉向（2026 年 4 月 Mercedes-Benz EQS 就是第一款德系量產 SbW），**這條 1988 年的法規，在「方向盤和輪子之間要不要有鋼桿」這個問題上，其實跟得上時代。**

真正卡住 Cybercab 的，不是 R79 的機械連結要求，而是**整套車輛型式認證體系的預設值**：每一個檢測項目、每一份規範、每一個表格的欄位——全部預設車上有方向盤、有踏板、有駕駛人視野。方向機柱可以拆掉，但「預設車上有人開」的整個認證邏輯還沒拆。

這不是 R79 一條法規的問題。是一整個世代的車輛認證體系，**從來沒有想過「車上不坐人」這件事。**

一條 1988 年為「保護駕駛人」寫的法規體系，碰上一台連駕駛人都沒有的車。這不是「法規落後」——這是兩個時代的物種在同一個法律體系裡相撞。
...
需要注意：FMVSS 的負面表列不等於沒有規則。在傳統車輛領域，FMVSS 的標準同樣是 prescriptive 規定式的——碰撞承受力、安全帶拉力、車燈亮度，全是具體數字。Robotaxi 能在美國先上路，關鍵是兩件事的交叉：（一）self-certification 程序不需要事前政府審查；（二）ADS 領域恰好還沒有聯邦法規——不是刻意寬鬆，是還沒來得及寫。這兩個條件的交叉，創造了一個法規空白的窗口。

而在負面表列的寫法下，這個空白不是障礙，反而是機會：
...
這三個維度——法規寫法（負面表列）、認證程序（self-certification 自我認證）、問責時機（事後問責）——在美國恰好組成了一個對 Robotaxi 極度友善的組合，和台灣正好相反。但它們不是不可分割的 package。台灣可以在維持型式認證的同時，調整其中的方法論——正如 Article 39 所示。
...
不是某個人的問題。不是某個機關的懈怠。是一整套制度的底層邏輯——正面表列 vs 負面表列、型式認證 vs 自我認證、「沒寫可以就是不行」vs「沒說不行就是行」——這些維度在台灣恰好全部疊在一起，形成了最大的阻力。但它們可以逐個鬆動——從方法論開始。而這些邏輯像地心引力一樣，無聲地、持續地、系統性地拉住了台灣的腳步。
