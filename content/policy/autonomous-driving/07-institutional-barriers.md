...
交通部有權決定接受哪些國際認證。**2026 年 4 月 10 日，荷蘭 RDW 正式核准了 Tesla FSD 的 Article 39 申請**——台灣現在就可以用一紙函令認可：「已取得歐盟型式認證的車輛，視同符合台灣檢測基準。」這不需要修法。不需要立法院。這是部會命令層級的決定。採認對象已經存在，只差一個政策決定。
